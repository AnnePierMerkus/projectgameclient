...
public class GameAI extends GameOptions {
    ...
    public void copyThread(int threadFrom, int threadTo) {
        ...
        // Update the previous board
        this.getBoard().emptyAllPrevious(threadTo);
        ...
        // Update the moveCounter
        this.getBoard().setMoveCounter(threadTo, this.getBoard().getMoveCounter(threadFrom));
        System.out.println("GETBOARD" + this.getBoard().getMoveCounter(threadTo));
    }
